...
- Don't filter and show error message _(Not useful for our use case)_
...
> ***Note:***
> _You will not get contents of transformed text (let's say `,` in our case) in the callback of `onValueChange` since it's not modified directly but it's just a visual change by `VisualTransformation`._

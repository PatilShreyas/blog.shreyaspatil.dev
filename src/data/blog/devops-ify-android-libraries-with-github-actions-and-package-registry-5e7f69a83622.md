...
*Navigate to <https://github.com/settings/tokens> and then click*[Generate New Token](https://github.com/settings/tokens/new).** Make sure to check scope — `read:packages`
...
*Just open `build.gradle` of the app module.* Add repository for GitHub package.
...
*[Example Repository](https://github.com/PatilShreyas/AndroidGPR)* [GitHub Packages](https://docs.github.com/en/free-pro-team@latest/packages/publishing-and-managing-packages/about-github-packages)
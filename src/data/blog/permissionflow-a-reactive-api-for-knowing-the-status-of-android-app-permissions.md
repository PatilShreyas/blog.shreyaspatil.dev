...
*If you want to observe***a single permission state***, use a method `PermissionFlow#getPermissionState`* If you want to observe multiple permissions' state, use a method `PermissionFlow#getMultiplePermissionState`
...
*[PermissionFlow - GitHub](https://github.com/PatilShreyas/permission-flow-android)* [PermissionFlow API](https://patilshreyas.github.io/permission-flow-android/docs/permission-flow/dev.shreyaspatil.permissionFlow/-permission-flow/index.html)
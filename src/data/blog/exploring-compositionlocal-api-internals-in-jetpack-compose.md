...
*`provides` - Always sets the value, overriding any parent-provided value* `providesDefault` - Only sets the value if no ancestor has already provided it. Useful for library components that want to offer a default but respect app-level overrides:
...
**API Variants:**|**Function**|**Use Case** |
| --- | --- |
...
**The four holder types serve different purposes:**|**Holder**|**Storage**|**When Used**|**Snapshot Tracked?** |
| --- | --- | --- | --- |
...
### **When to Use Which (Examples):**|**Use Case**|**Type**|**Reason** |
| --- | --- | --- |

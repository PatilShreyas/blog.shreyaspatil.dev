...
![](../../assets/images/content/you-can-t-multitask-your-ai-agent-can/img-55bc9061.png)
...
## **🔧 Patterns That Make This Work**###**Naming convention**
...
*Tasks share a build cache with side effects (common in multi-module projects)* Both tasks modify the same build files (such as `build.gradle`, `gradle/libs.versions.toml`)
...
Let's catch up on [ **X**](https://twitter.com/imShreyasPatil) or [**visit my site**](https://shreyaspatil.dev/) to know more about me 😎.***## 📚References* [https://www.apa.org/topics/research/multitasking](https://www.apa.org/topics/research/multitasking)

*[https://git-scm.com/docs/git-worktree](https://git-scm.com/docs/git-worktree)* [https://code.claude.com/docs/en/common-workflows#run-parallel-claude-code-sessions-with-git-worktrees](https://code.claude.com/docs/en/common-workflows#run-parallel-claude-code-sessions-with-git-worktrees)